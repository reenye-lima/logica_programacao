...
Modifique o programa de desconto.

## Nova regra

- Produtos com preço **maior ou igual a R$ 200,00** recebem **15% de desconto**.
- Produtos abaixo de R$ 200,00 recebem **5% de desconto**.
...
Neste exercício, tanto o `if` quanto o `else` realizarão cálculos.
...
Utilizamos quando queremos verificar uma condição:
...
Utilizamos quando existem dois caminhos possíveis:
...
**3. Identifique o processamento.**

**4. Identifique a condição.**

**5. Defina o que acontece no SIM.**

**6. Defina o que acontece no NÃO.**

**7. Monte o algoritmo.**

**8. Monte o fluxograma.**

**9. Finalmente, escreva o código em C.**